...
const About = () => {
  return (
    <section className="bg-white rounded-xl shadow-black shadow-2xl max-w-4xl mx-auto py-12 px-6 mt-32 mb-32">
      <h1 className='text-4xl font-extrabold text-center text-black mb-8'>About Us</h1>
      <h2 className="text-5xl font-semibold text-center text-black  mb-12">Our Manager Team</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-48">
        <div className="relative flex flex-col items-center">
          <div className="absolute  left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 shadow-slate-600  shadow-xl mt-[-7rem] overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 ">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/1702989116329.jpeg" alt="Saikat Biswas" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center  w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative  flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl  overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 ">
              <img className="w-full h-full object-cover brightness-150 hover:brightness-200" src="/src/photos/ankita.jpeg" alt="Ankita Debnath"  />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110  ">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/Diptanu.jpeg" alt="Diptanu Sarkar" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/Dhritiman.jpeg" alt="Dhritiman Roy" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 ">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/Adwaita.jpeg" alt="adwaita" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110 ">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/Ash.jpg" alt="asmita" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/bhatta.jpeg" alt="deeptanu" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
        ...
        <div className="relative mt-36 flex flex-col items-center">
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 z-10">
            <div className="w-64 h-64 mt-[-7rem] shadow-slate-600 shadow-xl overflow-hidden rounded-full transition-transform duration-300 ease-in-out transform hover:scale-110">
              <img className="w-full h-full object-cover hover:brightness-125" src="/src/photos/Tam.jpeg" alt="tamanna" />
            </div>
          </div>
          <div className="bg-cyan-100 rounded-lg shadow-black shadow-xl p-6 mt-20 text-center w-full max-w-sm relative z-0 transition-transform duration-300 ease-in-out transform hover:scale-110 hover:bg-cyan-200">
